#!/usr/bin/env python3
"""
Fetch the Pantrist OpenAPI spec and regenerate the Python addon client.
...
SPEC_URL = "https://api.pantrist.app/swagger-ui-yaml"

REPO_ROOT = Path(__file__).resolve().parent.parent
SPEC_FILE = REPO_ROOT / "openapi-watch.yaml"
OUTPUT_DIR = REPO_ROOT / "pantrist/app/pantrist_client"
...
def generate(spec: Path) -> None:
    ...
    print("  Done. Commit pantrist/app/pantrist_client/.")
