...
from ...models.add_by_barcode_dto import AddByBarcodeDto
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/list/{list_id}/shoppingList/add-by-barcode".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Add an item to the shopping list by barcode
     ...
     Looks up the barcode in the Pantrist catalog and adds the resolved product to the shopping list.
    Returns 404 if the barcode is unknown.
