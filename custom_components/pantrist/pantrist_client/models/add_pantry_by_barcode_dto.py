...
T = TypeVar("T", bound="AddPantryByBarcodeDto")


@_attrs_define
class AddPantryByBarcodeDto:
    """
    Attributes:
        barcode (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        add_pantry_by_barcode_dto = cls(
            barcode=barcode,
            amount=amount,
            unit_id=unit_id,
        )

        add_pantry_by_barcode_dto.additional_properties = d
        return add_pantry_by_barcode_dto
